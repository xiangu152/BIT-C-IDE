...
QT_MOC_LITERAL(3, 24, 10), // "searchtext"
QT_MOC_LITERAL(4, 35, 10), // "stopSearch"
QT_MOC_LITERAL(5, 46, 10), // "searchNext"
...
QT_MOC_LITERAL(8, 103, 23) // "on_pushButton_3_clicked"
    ...
    "SearchForm\0startSearch\0\0searchtext\0"
    "stopSearch\0searchNext\0on_pushButton_clicked\0"
...
void SearchForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->startSearch((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->stopSearch((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->searchNext((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SearchForm::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchForm::startSearch)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SearchForm::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchForm::stopSearch)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SearchForm::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchForm::searchNext)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SearchForm::startSearch(QString _t1)
{
...
// SIGNAL 1
void SearchForm::stopSearch(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void SearchForm::searchNext(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
